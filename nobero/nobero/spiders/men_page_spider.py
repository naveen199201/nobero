...
class MenPageSpider(scrapy.Spider):
    ...
    start_urls = ["https://nobero.com/pages/men",
                  "https://nobero.com/collections/mens-oversized-tees?page=1&section_id=template--16047755788454__product-grid"]
    ...
    def parse_product(self, response):
        ...
        item["img"] = response.css(
            "figure#image-container img::attr(src)")[0].get().strip("//")
        ...
        self.logger.debug(f"Yielding item: {item}")
        yield item
